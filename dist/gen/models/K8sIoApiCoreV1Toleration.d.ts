...
*/
export declare class K8sIoApiCoreV1Toleration {
    /**
...
export declare enum K8sIoApiCoreV1TolerationEffectEnum {
    NoExecute = "NoExecute",
    NoSchedule = "NoSchedule",
    PreferNoSchedule = "PreferNoSchedule"
}
export declare enum K8sIoApiCoreV1TolerationOperatorEnum {
    Equal = "Equal",
    Exists = "Exists"
}
