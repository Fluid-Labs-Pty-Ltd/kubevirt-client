...
*/
export declare class K8sIoApiCoreV1TopologySpreadConstraint {
...
export declare enum K8sIoApiCoreV1TopologySpreadConstraintNodeAffinityPolicyEnum {
    Honor = "Honor",
    Ignore = "Ignore"
}
export declare enum K8sIoApiCoreV1TopologySpreadConstraintNodeTaintsPolicyEnum {
    Honor = "Honor",
    Ignore = "Ignore"
}
export declare enum K8sIoApiCoreV1TopologySpreadConstraintWhenUnsatisfiableEnum {
