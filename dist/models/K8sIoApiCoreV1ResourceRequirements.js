...
export function K8sIoApiCoreV1ResourceRequirementsFromJSONTyped(json, _ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function K8sIoApiCoreV1ResourceRequirementsToJSONTyped(value, _ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
