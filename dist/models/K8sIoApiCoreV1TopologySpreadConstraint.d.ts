 ...
 * @export
 */
export declare const K8sIoApiCoreV1TopologySpreadConstraintNodeAffinityPolicyEnum: {
 ...
 * @export
 */
export declare const K8sIoApiCoreV1TopologySpreadConstraintNodeTaintsPolicyEnum: {
    readonly Honor: "Honor";
    readonly Ignore: "Ignore";
};
 ...
 * @export
 */
export declare const K8sIoApiCoreV1TopologySpreadConstraintWhenUnsatisfiableEnum: {
    readonly DoNotSchedule: "DoNotSchedule";
    readonly ScheduleAnyway: "ScheduleAnyway";
};
