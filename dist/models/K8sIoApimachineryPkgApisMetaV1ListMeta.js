...
export function K8sIoApimachineryPkgApisMetaV1ListMetaFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function K8sIoApimachineryPkgApisMetaV1ListMetaToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
