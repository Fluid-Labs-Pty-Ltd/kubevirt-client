...
export function K8sIoApimachineryPkgApisMetaV1ObjectMetaFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function K8sIoApimachineryPkgApisMetaV1ObjectMetaToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
