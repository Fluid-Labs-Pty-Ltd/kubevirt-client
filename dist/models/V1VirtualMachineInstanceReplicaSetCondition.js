...
export function V1VirtualMachineInstanceReplicaSetConditionFromJSONTyped(json, _ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function V1VirtualMachineInstanceReplicaSetConditionToJSONTyped(value, _ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
