 ...
 * @export
 */
export declare const V1VirtualMachineInstanceSpecDnsPolicyEnum: {
    readonly ClusterFirst: "ClusterFirst";
    readonly ClusterFirstWithHostNet: "ClusterFirstWithHostNet";
