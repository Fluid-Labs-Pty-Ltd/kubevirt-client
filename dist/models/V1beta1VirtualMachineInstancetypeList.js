...
import { V1beta1VirtualMachineInstancetypeFromJSON, V1beta1VirtualMachineInstancetypeToJSON, } from './V1beta1VirtualMachineInstancetype.js';
/**
 * Check if a given object implements the V1beta1VirtualMachineInstancetypeList interface.
 */
export function instanceOfV1beta1VirtualMachineInstancetypeList(value) {
...
export function V1beta1VirtualMachineInstancetypeListFromJSONTyped(json, _ignoreDiscriminator) {
    ...
    return {
        ...
        'items': (json['items'].map(V1beta1VirtualMachineInstancetypeFromJSON)),
...
export function V1beta1VirtualMachineInstancetypeListToJSONTyped(value, _ignoreDiscriminator = false) {
    ...
    return {
        ...
        'items': (value['items'].map(V1beta1VirtualMachineInstancetypeToJSON)),
        'kind': value['kind'],
