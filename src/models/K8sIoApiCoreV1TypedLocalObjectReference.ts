...
export function K8sIoApiCoreV1TypedLocalObjectReferenceToJSONTyped(value?: K8sIoApiCoreV1TypedLocalObjectReference | null, _ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
