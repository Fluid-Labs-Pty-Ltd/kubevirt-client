...
} from './V1VirtualMachineInstancePresetSpec.js';
...
export function V1VirtualMachineInstancePresetToJSONTyped(value?: V1VirtualMachineInstancePreset | null, _ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
