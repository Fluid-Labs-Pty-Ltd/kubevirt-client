 ...
 */
export function instanceOfV1alpha1VirtualMachineCloneList(value: object): value is V1alpha1VirtualMachineCloneList {
...
export function V1alpha1VirtualMachineCloneListToJSON(json: any): V1alpha1VirtualMachineCloneList {
