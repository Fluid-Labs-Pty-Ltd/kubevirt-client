...
} from './V1alpha1VirtualMachinePoolCondition.js';
...
export function V1alpha1VirtualMachinePoolStatusToJSONTyped(value?: V1alpha1VirtualMachinePoolStatus | null, _ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
